...
if __name__ == '__main__':
    ...
    # #target_layers_str = "model.encoder._conv_head"
    # #target_layers_str = "model.encoder._blocks[15]._bn2"
    # target_layers_str = "model.encoder._blocks[9]._project_conv"
    # target_layers_name=str.split(target_layers_str, '.')[-2]
    # target_layers=[eval(target_layers_str)]
    ...
    # target_layers_str = "model.transformer[7].attention.output_linear[0]"
    # target_layers_name=str.split(target_layers_str, '.')[-3]
    # target_layers=[eval(target_layers_str)]
    # print(target_layers[0])
    ...
    # target_layers_str = "model.transformer[2].attention.output_linear"
    # target_layers=[eval(target_layers_str)]
    # print(target_layers[0])
    ...
    for batch_idx, batch in enumerate(trainer.test_loader):
        ...
        target_layer_dir = './%s'%target_layers_name
        if not os.path.isdir(target_layer_dir):
            os.mkdir(target_layer_dir)
        vid_dir = os.path.join(target_layer_dir,vid_name)
        ...
        #cam.batch_size = 32
        cam.batch_size = config['train']['trainer']['batch_size']
        ...
        copy(args.config, target_layer_dir)
