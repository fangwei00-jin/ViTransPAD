...
class GuidedBackpropReLUModel:
    ...
    def __call__(self, input_img, target_category=None):
        ...
        """
        ### Again, here the author uses the loss instead of the predicted probability will misguided the users !!!!
        """
        loss = output[0, target_category]
        loss.backward(retain_graph=True)

        ### the ouput is the gradient of the input image but not the gradient of the feature maps of the target layer
