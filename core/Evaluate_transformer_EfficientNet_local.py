...
class Evaluate():
    ...
    def infer(self, faceframes, masks, device):
        ...
        #for f in range(0, video_length, 1):  ## overlap  2$neighbor_stride-2 frames
            ...
            with torch.no_grad():
                ...
                faces_tensor_mask = (faces_tensors_clip * (1 - mask_tensors_clip).float()).view(1, len(infer_frames_ids), 3, self.h, self.w)
    ...
    def evaluate(self, ep, ckpt):
        ...
        ### test ###
        ## threshold=0.5 means to get the score of the test images for the later evaluation
