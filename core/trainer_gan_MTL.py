...
class Trainer():
    ...
    def _train_epoch(self, pbar):
        ...
        for batch_idx, batch  in enumerate(self.train_loader):
            ...
            pred_depth_maps, y_dec = self.netG(masked_frame, masks)
            ...
            gen_loss = 0.1*loss_softmax_depth
            dis_loss = 0
            ...
            if self.config['global_rank'] == 0:
                ...
                if self.config['global_rank'] == 0:
                    ...
                    print('Train Epoch: {}/{} [ {}/{} batch)] time:{:.2f} \tdepth_map_gen_loss: {:.6f}, gan_loss: {:.6f}  dis_loss: {:.6f} loss_softmax_depth : {:.6f}'.format(
                            int(self.epoch), int(self.train_args['iterations']/len(self.train_loader)), (batch_idx), len(self.train_loader),
                             abs(tt[-1] - tt[-2]), valid_loss.item(), gan_loss.item(), dis_loss.item(), loss_softmax_depth.item()))
