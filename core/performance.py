...
def performances(map_score_val_filename, map_score_test_filename):
    ...
    return val_threshold, best_test_threshold, val_ACC, val_APCER, val_BPCER, val_ACER, test_ACC, test_APCER, test_BPCER, test_ACER, test_threshold_ACER


def get_threshold(map_score_val_filename):
    # val
    with open(map_score_val_filename, 'r') as file:
        lines = file.readlines()
    val_scores = []
