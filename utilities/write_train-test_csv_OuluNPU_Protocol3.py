...
#file_name = 'train_protocol3_12345_resample.csv'
videos = '/data/zming/datasets/Anti-spoof/OuluNPU/Train_files'
file_name = 'train_protocol3_12346.csv'
Phones = [1, 2, 3, 4, 6]#[1, 2, 3, 4, 5]#[6, 1, 2, 3, 4]#[5, 6, 1, 2, 3]#[4, 5, 6, 1, 2]#[3, 4, 5, 6, 1]#[2, 3, 4, 5, 6]#

# videos = '/data/zming/datasets/Anti-spoof/OuluNPU/Test_files'
# file_name = 'test_protocol3_1_resample.csv'
# Phones = [1]#[6]#[5]#[4]#[3]#[2]#
