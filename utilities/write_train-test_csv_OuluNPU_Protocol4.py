...
file_name = 'train_protocol4_12_124_56123_test.csv'
# videos = '/data/zming/datasets/Anti-spoof/OuluNPU/Dev_files'
# file_name = 'dev_protocol4_12_124_12345_resample.csv'
Phones = [5, 6, 1, 2, 3]#[1, 2, 3, 4, 6]#[2, 3, 4, 5, 6]#[1, 2, 3, 4, 5]#[6, 1, 2, 3, 4]#[5, 6, 1, 2, 3]#[4, 5, 6, 1, 2]#[3, 4, 5, 6, 1]#
Sessions=[1,2]
Files = [1, 2, 4]

# videos = '/data/zming/datasets/Anti-spoof/OuluNPU/Test_files'
# file_name = 'test_protocol4_3_135_1.csv'
# Phones = [1]#[6]#[5]#[4]#[3]#[2]#
# Sessions=[3] ## Test
# Files = [1, 3, 5]
...
def main():
	with open(os.path.join(videos, file_name), 'w') as cvsfile:
		...
		for folder in folders:
			...
			if int(Phone) in Phones and int(Session) in Sessions and int(File) in Files:
				print (folder)
				...
				### Resample : Upsample the liveness samples
				# train_data_resample = []
				# if spooflabel == 1:
				# 	## to balance the live video with the attack video since attack:live is 2:1
				# 	for i in range(2):
				# 		print(i)
				# 		for l in train_data:
